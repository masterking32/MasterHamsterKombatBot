...
✅ Tested and confirmed to work as of `20 September 2024`. ✅
...
Windows
```bat
py -m pip install requests colorlog
```
Linux & Mac
```bash
...
- Copy the `config.py.example` file and rename the copy to `config.py`:
